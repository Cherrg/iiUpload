...
$module_directory = 'ii_upload_admin';
$module_name = 'IImage Upload Admin';
$module_function = 'tool';
$module_version = '0.0.1';
$module_platform = '2.8.x';
$module_author = 'Michael Gnehr';
$module_license = 'Copyright (C) 2016, Michael Gnehr - All rights reserved';
$module_description = 'Dummy Module for IIUpload. Used to control user access to module settings.';
